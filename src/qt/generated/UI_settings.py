...
class Ui_TabSettings(object):
    def setupUi(self, TabSettings):
        ...
        sizePolicy.setHeightForWidth(self.lbl_controller_port.sizePolicy().hasHeightForWidth())
        self.lbl_controller_port.setSizePolicy(sizePolicy)
        font1 = QFont()
        ...
        self.lbl_gamma_corr.setFont(font)
        ...
        sizePolicy1.setHeightForWidth(self.cb_controller_ports.sizePolicy().hasHeightForWidth())
        self.cb_controller_ports.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.btn_matrix_connect.sizePolicy().hasHeightForWidth())
        self.btn_matrix_connect.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.btn_test_gamma_red.sizePolicy().hasHeightForWidth())
        self.btn_test_gamma_red.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.cb_matrix_ports.sizePolicy().hasHeightForWidth())
        self.cb_matrix_ports.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.btn_controller_connect.sizePolicy().hasHeightForWidth())
        self.btn_controller_connect.setSizePolicy(sizePolicy1)
        ...
        sizePolicy.setHeightForWidth(self.lbl_matrix_port.sizePolicy().hasHeightForWidth())
        self.lbl_matrix_port.setSizePolicy(sizePolicy)
